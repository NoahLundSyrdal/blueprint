...
class VerifyInUmlActionRegressionTest {
    ...
    fun `post apply flow uses refresh uml wording for verification action`() {
        ...
        assertTrue(source.contains("\${postApplyVerifyState} Refresh UML From Code runs a separate manual verification refresh when you want to confirm it yourself."))
