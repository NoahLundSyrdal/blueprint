...
class VerifyInUmlActionRegressionTest {
    ...
    fun `post apply flow uses refresh uml wording for verification action`() {
        ...
        assertTrue(source.contains("toolTipText = \"After apply, Blueprint already refreshed the code-backed UML once. Use Refresh UML From Code to run a separate verification refresh when you want to confirm it yourself.\""))
        ...
        assertTrue(source.contains("\${postApplyVerifyState} Refresh UML From Code runs a separate verification refresh when you want to confirm it yourself."))
        ...
        assertTrue(source.contains("Click Refresh UML From Code when you want a separate verification refresh."))
