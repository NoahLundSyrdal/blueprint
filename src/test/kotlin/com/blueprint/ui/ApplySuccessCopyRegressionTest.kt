...
class ApplySuccessCopyRegressionTest {
    ...
    fun `apply success message keeps verification steps clear and compile safe`() {
        ...
        assertTrue(source.contains("\"Refresh UML From Code reruns that refresh when you want to verify it yourself.\""))
        ...
        assertTrue(source.contains("listOf(summaryLine, whatChanged, commandBlock, refreshNote, runNote, undoNote, umlRefreshLine, verifyStateLine, highlightLine)"))
    }
}
