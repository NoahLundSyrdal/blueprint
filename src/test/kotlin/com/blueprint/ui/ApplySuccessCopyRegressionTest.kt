...
class ApplySuccessCopyRegressionTest {
    ...
    fun `apply success message keeps verification steps clear and compile safe`() {
        ...
        assertTrue(source.contains("\"Apply complete. The code-backed UML was refreshed after apply.\""))
        assertTrue(source.contains("\"Refresh UML From Code again anytime to verify after more edits.\""))
