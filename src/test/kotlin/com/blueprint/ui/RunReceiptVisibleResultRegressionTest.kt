...
class RunReceiptVisibleResultRegressionTest {
    ...
    fun `manual demo runner dialog and activity log emphasize seeing the feature exist`() {
        ...
        assertTrue(source.contains("7. Run the changed app with: \$runCommand"))
        assertTrue(source.contains("8. Confirm the expected visible result in Blueprint, the launched app, a browser, or terminal output."))
