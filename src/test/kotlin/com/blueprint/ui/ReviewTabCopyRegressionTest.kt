...
class ReviewTabCopyRegressionTest {
    ...
    fun `review tab keeps what changed separate from safety explanation`() {
        ...
        assertTrue(source.contains("appendLine(\"- Start with the approval reason and safety proof below.\")"))
        ...
        assertTrue(source.contains("appendLine(\"- Confirm the diff scope summary, changed files, and approval reason before apply.\")"))
