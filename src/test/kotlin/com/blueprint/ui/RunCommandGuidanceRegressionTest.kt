...
class RunCommandGuidanceRegressionTest {
    ...
    fun `manual run guidance names likely entry files and fallback search targets`() {
        ...
        assertTrue(source.contains("- Refresh UML From Code after you pick the Python folder you want to verify."))
        assertTrue(source.contains("- Open a likely entry file or package root manually."))
