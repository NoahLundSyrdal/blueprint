...
class ManualRunFallbackCardRegressionTest {
    ...
    fun `manual fallback card explains automatic vs manual run steps and likely entry action`() {
        ...
        assertTrue(source.contains("What Blueprint can do now: Refresh UML From Code to re-check the current Python folder and Open Likely Entry File to inspect the strongest launcher candidate."))
